  ...
  return (
    <div className="h-full overflow-auto">
      <PageContainer>
        ...
        {user ? (
          <TalentLibraryContent />
        ) : (
          <SignInPrompt
            icon={<User className="h-12 w-12" />}
            title="Sign in to manage talent"
            description="Build a reusable talent library to keep characters consistent across your sequences."
          />
        )}
      </PageContainer>
    </div>
